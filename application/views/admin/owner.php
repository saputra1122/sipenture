...
<html lang="en">
						  ...
						  <?php $no=1; foreach($read as $d) {?>
								<tr align="center">
									...
									<td class="text-center">
										...
										<button class="btn btn-danger btn-sm" title="Hapus" onclick="return hapus(`<?= $d->id ?>`,`<?= $d->nama_owner ?>`)"><i class="fas fa-trash-alt"></i></button>
	...
	<script>
        ...
        function tambah(){
            ...
            $('#modal-header').html('<i class="fa fa-plus"></i> Tambah Owner');
            ...
            document.form.action = '<?php echo base_url();?>Admin/owner_add';
    };
    function ubah(id,nama_owner,no_hp,alamat){
			
            $('#Modal').modal('show');
            
            $('#modal-header').html('<i class="fas fa-edit"></i> Update Owner');
            $('#modal-body-update-or-create').removeClass('d-none');
            $('#modal-body-delete').addClass('d-none');
            $('#modal-button').html('Save');
            $('#modal-button').removeClass('btn-danger');
            ...
            document.form.action = '<?php echo base_url();?>Admin/owner_update';
    };
    function hapus(id,nama_owner){
				...
				document.form.action = '<?php echo base_url();?>Admin/owner_delete';
			};
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<span id="modal-body-update-or-create">
							<label>Nama</label>
							<input type="text" id="nama_owner" name="nama_owner" class="form-control" placeholder="Nama" autofocus>
                            <label>No HP</label>
